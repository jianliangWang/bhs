...
public class LoginTests {
    ...
    @Autowired
    ISystemRoleAuthorizationService roleAuthorizationService;
    ...
    public void testGetUserAuthorityInfo() {
        roleAuthorizationService.getAuthorityInfo(1);
    }
    ...
    public void testLogin() throws Exception {
        ...
        String verifyCode = "mnacc";
        String key = "e0dd0710-bb27-4c75-952e-16eae52d2633";
